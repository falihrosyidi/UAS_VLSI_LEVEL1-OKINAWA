...
HD_PWD='D:/Falih/VLSI/UAS_VLSI_LEVEL1-OKINAWA/project_UAS_VLSI/project_UAS_VLSI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neuron_b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neuron_b.tcl
